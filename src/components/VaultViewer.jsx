...
// Static imports of all vault markdown files
import waysToMonetize from '../content/vault/ways-to-monetize-ai.md?raw';
import elitePrompts from '../content/vault/elite-ai-prompts.md?raw';
import offlineBusinesses from '../content/vault/offline-ai-businesses.md?raw';
import workflows from '../content/vault/ai-monetization-workflows.md?raw';
import masteryHandbook from '../content/vault/gpt-mastery-handbook.md?raw';
import advancedEngineering from '../content/vault/advanced-ai-engineering.md?raw';

const VAULT = {
  'ways-to-monetize-ai': waysToMonetize,
  'elite-ai-prompts': elitePrompts,
  'offline-ai-businesses': offlineBusinesses,
  'ai-monetization-workflows': workflows,
  'gpt-mastery-handbook': masteryHandbook,
  'advanced-ai-engineering': advancedEngineering,
};
  ...
  return (
    <div className="min-h-screen vault-page">
      ...
      <motion.div
        ...
        className="sticky top-0 z-50 glass rounded-none border-x-0 border-t-0 p-4 px-8 flex flex-col gap-3"
      >
      ...
      <motion.main
        ...
        className="vault-content max-w-4xl mx-auto p-8 md:p-16"
      >
        <ReactMarkdown
